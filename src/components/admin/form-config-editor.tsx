            ...
            {fields.map((field, index) => {
                ...
                return (
                  <Card key={field.id} className={cn("p-4 space-y-3 bg-muted/30 relative", isPast && "opacity-70")}>
                    {isPast && <div className="absolute inset-0 bg-transparent z-10" title="Este partido ya pasó y no se puede editar."></div>}
                    ...
                    <FormField
                      ...
                      render={({ field: inputField }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Ej: Final Liga A vs Liga B" {...inputField} disabled={isPast} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        render={({ field: inputField }) => (
                            ...
                            <FormControl>
                                <Input type="time" placeholder="15:00" {...inputField} disabled={isPast} />
                            </FormControl>
                            <FormMessage />
                            </FormItem>
                        )}
                        ...
                        render={({ field: inputField }) => (
                            ...
                            <FormControl>
                                <Input placeholder="Ej: Cancha Principal" {...inputField} disabled={isPast} />
                            </FormControl>
                            <FormMessage />
                            </FormItem>
                        )}
